...
export default function Home() {
  ...
  const handleSearch1 = () => {
    // Điều hướng đến trang tìm kiếm khi nhấn Enter
    history.push(`/search/${searchTerm}`);
  };

  const handleClick = () => {
    // Điều hướng đến trang tìm kiếm khi click vào ô nhập liệu (bao ngoài)
    if (searchTerm) {
      history.push(`/search/${searchTerm}`);
    }
  };
      ...
      <div
        ...
        <div className="h-35 bg-white/30 relative rounded-2xl flex items-center p-4 shadow-md mt-5">
          <div className="h-21 bg-white flex flex-1 rounded-xl items-center p-4 shadow">
            <div
              className="flex justify-center items-center mr-7 w-60 cursor-pointer"
              onClick={() => navigate('/bestforyou')} // Điều hướng khi click vào ngoài input
            >
              <Input
                ...
                onPressEnter={handleSearch1} // Điều hướng khi nhấn Enter
              />
            </div>
